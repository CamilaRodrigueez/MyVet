...
namespace Infraestructure.Core.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IRepository<ServicesEntity> servicesRepository;
        ...
        public IRepository<ServicesEntity> ServicesRepository
        {
            get
            {
                if (this.servicesRepository == null)
                    this.servicesRepository = new Repository<ServicesEntity>(_context);
